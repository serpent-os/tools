...
impl StonePayloadMetaPrimitive {
    fn size(&self) -> usize {
        match self {
            StonePayloadMetaPrimitive::Int8(_) => std::mem::size_of::<i8>(),
            StonePayloadMetaPrimitive::Uint8(_) => std::mem::size_of::<u8>(),
            StonePayloadMetaPrimitive::Int16(_) => std::mem::size_of::<i16>(),
            StonePayloadMetaPrimitive::Uint16(_) => std::mem::size_of::<u16>(),
            StonePayloadMetaPrimitive::Int32(_) => std::mem::size_of::<i32>(),
            StonePayloadMetaPrimitive::Uint32(_) => std::mem::size_of::<u32>(),
            StonePayloadMetaPrimitive::Int64(_) => std::mem::size_of::<i64>(),
            StonePayloadMetaPrimitive::Uint64(_) => std::mem::size_of::<u64>(),
            // nul terminator
