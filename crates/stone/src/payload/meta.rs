...
impl StonePayloadMetaKind {
    fn size(&self) -> usize {
        match self {
            StonePayloadMetaKind::Int8(_) => std::mem::size_of::<i8>(),
            StonePayloadMetaKind::Uint8(_) => std::mem::size_of::<u8>(),
            StonePayloadMetaKind::Int16(_) => std::mem::size_of::<i16>(),
            StonePayloadMetaKind::Uint16(_) => std::mem::size_of::<u16>(),
            StonePayloadMetaKind::Int32(_) => std::mem::size_of::<i32>(),
            StonePayloadMetaKind::Uint32(_) => std::mem::size_of::<u32>(),
            StonePayloadMetaKind::Int64(_) => std::mem::size_of::<i64>(),
            StonePayloadMetaKind::Uint64(_) => std::mem::size_of::<u64>(),
            // nul terminator
